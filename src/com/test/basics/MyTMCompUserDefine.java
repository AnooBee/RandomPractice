...
public class MyTMCompUserDefine {
	...
	public static class Worker {
		...
		/*
		 * Called by entry.getKey() Overriding toString() method from super
		 * class Object Since key is Object we are return our own key value
		 */
	...
	public static class MyNameComp implements Comparator<Worker> {
